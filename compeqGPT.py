...
st.sidebar.write("📦 localStorage 值：", repr(raw_json))  # ⬅️ 偵錯用，幫你觀察值

# 若是初次進入（localStorage 是空）就初始化
